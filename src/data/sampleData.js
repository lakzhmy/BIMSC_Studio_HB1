...
export const courseTimeline = [
  {
    week: 1,
    title: 'Introduction',
    description: 'Site Analysis Pitch, Research topics.',
    deliverables: [
      { id: 1, team: 'general', text: 'Site Analysis Pitch' },
      { id: 2, team: 'program', text: 'Define research topics' },
      { id: 3, team: 'data', text: 'Define data collection parameters' },
      { id: 4, team: 'structure', text: 'Initial massing analysis' }
    ]
  },
  {
    week: 2,
    title: 'Establish Playground Rules',
    description: 'Key outcomes, Computational tests.',
    deliverables: [
      { id: 1, team: 'general', text: 'Agree on playground rules' },
      { id: 2, team: 'program', text: 'Define key outcomes' },
      { id: 3, team: 'data', text: 'Outline computational tests' },
      { id: 4, team: 'structure', text: 'Translate rules into structural constraints' }
    ]
  },
  {
    week: 3,
    title: 'Applied Research',
    description: 'Parametric implementations, Performance evaluation.',
    deliverables: [
      { id: 1, team: 'general', text: 'Applied research direction' },
      { id: 2, team: 'program', text: 'Parametric program tests' },
      { id: 3, team: 'data', text: 'Set performance evaluation criteria' },
      { id: 4, team: 'structure', text: 'Prototype parametric structure' }
    ]
  },
  {
    week: 4,
    title: 'Production and Narrative for Midterm',
    description: 'Review material, Alignment.',
    deliverables: [
      { id: 1, team: 'general', text: 'Compile midterm narrative' },
      { id: 2, team: 'program', text: 'Align program story' },
      { id: 3, team: 'data', text: 'Prepare review material' },
      { id: 4, team: 'structure', text: 'Align analysis and drawings' }
    ]
  },
  {
    week: 5,
    title: 'Midterm',
    description: 'Analyze conclusions.',
    deliverables: [
      { id: 1, team: 'general', text: 'Midterm review summary' },
      { id: 2, team: 'program', text: 'Summarize program conclusions' },
      { id: 3, team: 'data', text: 'Analyze data conclusions' },
      { id: 4, team: 'structure', text: 'Assess structural conclusions' }
    ]
  },
  {
    week: 6,
    title: 'Digest Midterm',
    description: 'Further development, Feedback incorporation.',
    deliverables: [
      { id: 1, team: 'general', text: 'Digest feedback' },
      { id: 2, team: 'program', text: 'Refine program strategy' },
      { id: 3, team: 'data', text: 'Update data pipeline' },
      { id: 4, team: 'structure', text: 'Revise structural approach' }
    ]
  },
  {
    week: 7,
    title: 'Interoperability Check',
    description: 'Assess completeness, Define metrics.',
    deliverables: [
      { id: 1, team: 'general', text: 'Interoperability review' },
      { id: 2, team: 'program', text: 'Assess completeness' },
      { id: 3, team: 'data', text: 'Define metrics' },
      { id: 4, team: 'structure', text: 'Validate exchange workflow' }
    ]
  },
  {
    week: 8,
    title: 'Modeling Final Push',
    description: '3D models ready, Data flow robustness.',
    deliverables: [
      { id: 1, team: 'general', text: 'Finalize models for review' },
      { id: 2, team: 'program', text: 'Finalize program layouts' },
      { id: 3, team: 'data', text: 'Harden data flow' },
      { id: 4, team: 'structure', text: 'Finalize structural model' }
    ]
  },
  {
    week: 9,
    title: 'Production and Narrative for Final',
    description: 'Finalize design decisions.',
    deliverables: [
      { id: 1, team: 'general', text: 'Finalize narrative boards' },
      { id: 2, team: 'program', text: 'Finalize program decisions' },
      { id: 3, team: 'data', text: 'Finalize data visuals' },
      { id: 4, team: 'structure', text: 'Finalize structural documentation' }
    ]
  },
  {
    week: 10,
    title: 'Final Presentation',
    description: 'Completed hyperbuilding design.',
    deliverables: [
      { id: 1, team: 'general', text: 'Final presentation package' },
      { id: 2, team: 'program', text: 'Present final program' },
      { id: 3, team: 'data', text: 'Deliver final data package' },
      { id: 4, team: 'structure', text: 'Present final structure' }
    ]
  }
]
